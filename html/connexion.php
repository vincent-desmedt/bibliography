...
<html lang="fr">
	<head>
		...
		<title>Books (bibliothèque en ligne) - Connexion</title>
	</head>
	<body>
        <header class="header connexion-page">
            ...
            <nav class="header-nav">
                ...
                <form class="header-nav__form" action="index.php" method="get">
                    ...
                    <ul class="header-nav__menu-connexion-list">
                        ...
                        <li class="header-nav__menu-connexion__elt"><a class="header-nav__menu-connexion__link" href="#" title="connexion">Connexion</a></li>
        ...
        <form class="access" action="connexion.php" method="post">
            <h2 class="access__heading">Connexion</h2>
