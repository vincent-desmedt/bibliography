...
<html lang="fr">
	<head>
		...
		<title>Books (bibliothèque en ligne) - Administration - ajouter un livre</title>
	</head>
	<body>
        ...
        <form class="administrator-update" action="add-book.php" method="post">
            <h2 class="administrator-update__heading"><a class="administrator-update__breadcrumb" href="./administration.php" title="fil d'ariane">Administration</a>&nbsp;→&nbsp;<a class="administrator-update__breadcrumb" href="./administration-espace-prive.php">espace&nbsp;privé</a> →&nbsp;ajouter&nbsp;un&nbsp;livre</h2>
