...
<html lang="fr">
	<head>
		...
		<title>Books (bibliothèque en ligne) - Les éditeurs</title>
	</head>
    <body>
        ...
        <section class="editors">
            <h2 class="editors__heading">Les éditeurs&nbsp;:&nbsp;</h2>
            <ul class="editors__list">
                <li class="editors__elt"><a class="editors__link" href="./editor.php" title="Atheneum, l'éditeur">Atheneum</a></li>
                <li class="editors__elt"><a class="editors__link" href="./editor.php" title="Atheneum, l'éditeur">Atheneum</a></li>
            </ul>
        </section>
        <footer class="footer">
