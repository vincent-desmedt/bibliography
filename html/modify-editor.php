...
<html lang="fr">
	<head>
		...
		<title>Books (bibliothèque en ligne) - Administration - modifier un éditeur</title>
	</head>
	<body>
        ...
        <form class="administrator-update" action="modify-author.php" method="post">
            <h2 class="administrator-update__heading"><a class="administrator-update__breadcrumb" href="./administration.php" title="fil d'ariane">Administration</a>&nbsp;→&nbsp;<a class="administrator-update__breadcrumb" href="./administration-espace-prive.php">espace&nbsp;privé</a> →&nbsp;modifier&nbsp;un&nbsp;éditeur</h2>
            ...
            <div class="administrator-update__block">
                ...
                <textarea id="description" class="administrator-update__input" placeholder="Ma description…" maxlength="500" rows="5" name="description" required></textarea>
            </div>
