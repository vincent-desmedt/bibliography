...
<html lang="fr">
	<head>
		...
		<title>Books (bibliothèque en ligne) - Les livres</title>
	</head>
    <body>
        <header class="header">
            ...
            <nav class="header-nav">
                ...
                <form class="header-nav__form" action="books.php" method="get">
                    ...
                    <ul class="header-nav__menu-list">
                        <li class="header-nav__menu-list__elt"><a class="header-nav__menu-list__link" href="#" title="livres">Livres</a></li>
        ...
        <section class="books">
            <h2 class="books__heading">Les livres&nbsp;:&nbsp;</h2>
            <a class="books__link-book" href="./book.php" title="Carl Mydans - Une paix violente (livre)">
