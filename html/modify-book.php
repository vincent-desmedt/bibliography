...
<html lang="fr">
	<head>
		...
		<title>Books (bibliothèque en ligne) - Administration - modifier un livre</title>
	</head>
	<body>
        ...
        <form class="administrator-update" action="modify-book.php" method="post">
            <h2 class="administrator-update__heading"><a class="administrator-update__breadcrumb" href="./administration.php" title="fil d'ariane">Administration</a>&nbsp;→&nbsp;<a class="administrator-update__breadcrumb" href="./administration-espace-prive.php">espace&nbsp;privé</a> →&nbsp;modifier&nbsp;un&nbsp;livre</h2>
            ...
            <div class="administrator-update__block">
                <label class="administrator-update__label-title" for="title">Titre</label>
                <input class="administrator-update__input-title" type="text" name="title" id="title" placeholder="Une paix violente" maxlength="50" required>
            </div>
            <div class="administrator-update__block">
                <label class="administrator-update__label-editor" for="editor">Édition</label>
            ...
            <div class="administrator-update__block">
                <label class="administrator-update__label-img" for="img">Image</label>
                <input class="administrator-update__input-img" type="file" name="img" id="img" accept="image/*">
            </div>
            <div class="administrator-update__block">
                <label class="administrator-update__label-content" for="content">Mon contenu</label>
                <textarea id="content" class="administrator-update__input" placeholder="Mon contenu…" rows="10" name="content"></textarea>
            </div>
            <button class="administrator-update__submit" type="submit" name="submit" value="book">Modifier</button>
